...
**Gaurav's style** (reference for quality):
...
**Jagdeep's style** (reference for brevity when multiple cases):
...
**Default to Gaurav's format** for 1-2 cases. Switch to Jagdeep's compact style if the user provides 3+ cases with minimal detail.
